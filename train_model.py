...
metadata = {
    ...
    "deployment_features": {
        "comparison_feature": "Compares feature importance between disease prediction and systolic prediction models",
        "classification_confidence_rule": "max predicted class probability from classifier.predict_proba",
        "regression_confidence_rule": "1 - MAE / predicted_systolic, clipped to 0-1",
        "regression_status_rule": "Status Normal atau Tidak Normal dihitung dari prediksi sistolik, input diastolik, usia, dan gender berdasarkan acuan tekanan darah normal per usia.",
        "explainable_ai": True,
        "explainable_ai_rule": "Uses built-in feature_importances_ from GradientBoostingClassifier and GradientBoostingRegressor to show top influential features",
        "app_title": "Prediksi Penyakit Kardiovaskular"
    }
}
